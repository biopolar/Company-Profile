...
<head>
    ...
    <title>Electronix.id - User</title>
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?= base_url('back-end/img/') . $user['foto']; ?>">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img src="<?= base_url('back-end/img/') . $user['foto']; ?>" alt="" class="card-img-top">
                        <div class="card-body">
                            <p class="card-text"><?= $user['nama']; ?></p>
                            <p class="card-text"><?= $user['email'] ?></p>
                            <p class="card-text">Anda sudah terdaftar sejak :</p>
                            <p class="card-text"><?= date('d F Y', $user['data_created']); ?></p>
                        </div>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Electronix.id <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
